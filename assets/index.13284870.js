...
Long Warp: Play one round of Rock-Paper-Scissors with your opponent. If you win, receive 1x Teleportation Token, giving you a free instant dodge from an attack of your choice. If you lose, discard the top card of your deck.`,variantId:131,fileStem:"0094a"}],J=e=>`https://mondomegabits.com/card/img/95/${e.fileStem}.jpg`,Se=e=>{const t=[];for(var a=0;a<e;a++)t.push($[Math.floor(Math.random()*$.length)]);return t},Ae=L('<div class="app"><div class="card-select"><h2>Click on a card to <span class="glow">MINT</span> it</h2><div class="card-select-cards"></div></div></div>'),Ee=L('<img width="168" height="284" alt="">'),Ie=L('<div class="minted-card-display"></div>'),Ce=L('<img alt="">'),Me=()=>{const[e,t]=se([]);ce(()=>{H()}),ue(()=>{H()});const a=i=>{const n=i.target,s=h=>{const l=JSON.parse(h.getAttribute("data-card"));t([...new Set([...e(),l])])},r=Math.random()<.5;ve([n],{callback:s,fallToLeft:r})},o=()=>{t([]),H()};return(()=>{const i=Ae.cloneNode(!0),n=i.firstChild,s=n.firstChild,r=s.nextSibling;return D(r,()=>Se(5).map(h=>(()=>{const l=Ee.cloneNode(!0);return l.$$click=a,P(c=>{const m=J(h),g=JSON.stringify(h);return m!==c._v$&&W(l,"src",c._v$=m),g!==c._v$2&&W(l,"data-card",c._v$2=g),c},{_v$:void 0,_v$2:void 0}),l})())),D(i,(()=>{const h=ge(()=>!!e().length,!0);return()=>h()&&(()=>{const l=Ie.cloneNode(!0);return l.$$click=o,D(l,()=>e().map(c=>{const m=J(c);return(()=>{const g=Ce.cloneNode(!0);return W(g,"src",m),g})()})),l})()})(),null),i})()};Te(["click"]);we(()=>pe(Me,{}),document.getElementById("root"));
