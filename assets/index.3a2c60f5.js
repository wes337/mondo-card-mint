(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))o(i);new MutationObserver(i=>{for(const n of i)if(n.type==="childList")for(const s of n.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&o(s)}).observe(document,{childList:!0,subtree:!0});function a(i){const n={};return i.integrity&&(n.integrity=i.integrity),i.referrerpolicy&&(n.referrerPolicy=i.referrerpolicy),i.crossorigin==="use-credentials"?n.credentials="include":i.crossorigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function o(i){if(i.ep)return;i.ep=!0;const n=a(i);fetch(i.href,n)}})();const S={};function re(e){S.context=e}const se=(e,t)=>e===t,F={equals:se};let J=te;const E=1,B=2,X={owned:null,cleanups:null,context:null,owner:null};var g=null;let I=null,m=null,b=null,A=null,Y=0;function le(e,t){const a=m,o=g,i=e.length===0,n=i?X:{owned:null,cleanups:null,context:null,owner:t||o},s=i?e:()=>e(()=>N(()=>j(n)));g=n,m=null;try{return P(s,!0)}finally{m=a,g=o}}function he(e,t){t=t?Object.assign({},F,t):F;const a={value:e,observers:null,observerSlots:null,comparator:t.equals||void 0},o=i=>(typeof i=="function"&&(i=i(a.value)),ee(a,i));return[Q.bind(a),o]}function H(e,t,a){const o=U(e,t,!1,E);G(o)}function Z(e,t,a){J=fe;const o=U(e,t,!1,E);o.user=!0,A?A.push(o):G(o)}function ce(e,t,a){a=a?Object.assign({},F,a):F;const o=U(e,t,!0,0);return o.observers=null,o.observerSlots=null,o.comparator=a.equals||void 0,G(o),Q.bind(o)}function N(e){let t,a=m;return m=null,t=e(),m=a,t}function ue(e){Z(()=>N(e))}function de(e){return g===null||(g.cleanups===null?g.cleanups=[e]:g.cleanups.push(e)),e}function Q(){const e=I;if(this.sources&&(this.state||e))if(this.state===E||e)G(this);else{const t=b;b=null,P(()=>L(this),!1),b=t}if(m){const t=this.observers?this.observers.length:0;m.sources?(m.sources.push(this),m.sourceSlots.push(t)):(m.sources=[this],m.sourceSlots=[t]),this.observers?(this.observers.push(m),this.observerSlots.push(m.sources.length-1)):(this.observers=[m],this.observerSlots=[m.sources.length-1])}return this.value}function ee(e,t,a){let o=e.value;return(!e.comparator||!e.comparator(o,t))&&(e.value=t,e.observers&&e.observers.length&&P(()=>{for(let i=0;i<e.observers.length;i+=1){const n=e.observers[i],s=I&&I.running;s&&I.disposed.has(n),(s&&!n.tState||!s&&!n.state)&&(n.pure?b.push(n):A.push(n),n.observers&&ae(n)),s||(n.state=E)}if(b.length>1e6)throw b=[],new Error},!1)),t}function G(e){if(!e.fn)return;j(e);const t=g,a=m,o=Y;m=g=e,me(e,e.value,o),m=a,g=t}function me(e,t,a){let o;try{o=e.fn(t)}catch(i){e.pure&&(e.state=E),oe(i)}(!e.updatedAt||e.updatedAt<=a)&&(e.updatedAt!=null&&"observers"in e?ee(e,o):e.value=o,e.updatedAt=a)}function U(e,t,a,o=E,i){const n={fn:e,state:o,updatedAt:null,owned:null,sources:null,sourceSlots:null,cleanups:null,value:t,owner:g,context:null,pure:a};return g===null||g!==X&&(g.owned?g.owned.push(n):g.owned=[n]),n}function x(e){const t=I;if(e.state===0||t)return;if(e.state===B||t)return L(e);if(e.suspense&&N(e.suspense.inFallback))return e.suspense.effects.push(e);const a=[e];for(;(e=e.owner)&&(!e.updatedAt||e.updatedAt<Y);)(e.state||t)&&a.push(e);for(let o=a.length-1;o>=0;o--)if(e=a[o],e.state===E||t)G(e);else if(e.state===B||t){const i=b;b=null,P(()=>L(e,a[0]),!1),b=i}}function P(e,t){if(b)return e();let a=!1;t||(b=[]),A?a=!0:A=[],Y++;try{const o=e();return ye(a),o}catch(o){b||(A=null),oe(o)}}function ye(e){if(b&&(te(b),b=null),e)return;const t=A;A=null,t.length&&P(()=>J(t),!1)}function te(e){for(let t=0;t<e.length;t++)x(e[t])}function fe(e){let t,a=0;for(t=0;t<e.length;t++){const o=e[t];o.user?e[a++]=o:x(o)}for(S.context&&re(),t=0;t<a;t++)x(e[t])}function L(e,t){const a=I;e.state=0;for(let o=0;o<e.sources.length;o+=1){const i=e.sources[o];i.sources&&(i.state===E||a?i!==t&&x(i):(i.state===B||a)&&L(i,t))}}function ae(e){const t=I;for(let a=0;a<e.observers.length;a+=1){const o=e.observers[a];(!o.state||t)&&(o.state=B,o.pure?b.push(o):A.push(o),o.observers&&ae(o))}}function j(e){let t;if(e.sources)for(;e.sources.length;){const a=e.sources.pop(),o=e.sourceSlots.pop(),i=a.observers;if(i&&i.length){const n=i.pop(),s=a.observerSlots.pop();o<i.length&&(n.sourceSlots[s]=o,i[o]=n,a.observerSlots[o]=s)}}if(e.owned){for(t=0;t<e.owned.length;t++)j(e.owned[t]);e.owned=null}if(e.cleanups){for(t=0;t<e.cleanups.length;t++)e.cleanups[t]();e.cleanups=null}e.state=0,e.context=null}function pe(e){return e instanceof Error||typeof e=="string"?e:new Error("Unknown error")}function oe(e){throw e=pe(e),e}function ie(e,t){return N(()=>e(t||{}))}function ge(e,t){return ce(e,void 0,t?void 0:{equals:t})}function be(e,t,a){let o=a.length,i=t.length,n=o,s=0,r=0,y=t[i-1].nextSibling,u=null;for(;s<i||r<n;){if(t[s]===a[r]){s++,r++;continue}for(;t[i-1]===a[n-1];)i--,n--;if(i===s){const l=n<o?r?a[r-1].nextSibling:a[n-r]:y;for(;r<n;)e.insertBefore(a[r++],l)}else if(n===r)for(;s<i;)(!u||!u.has(t[s]))&&t[s].remove(),s++;else if(t[s]===a[n-1]&&a[r]===t[i-1]){const l=t[--i].nextSibling;e.insertBefore(a[r++],t[s++].nextSibling),e.insertBefore(a[--n],l),t[i]=a[n]}else{if(!u){u=new Map;let w=r;for(;w<n;)u.set(a[w],w++)}const l=u.get(t[s]);if(l!=null)if(r<l&&l<n){let w=s,h=1,f;for(;++w<i&&w<n&&!((f=u.get(t[w]))==null||f!==l+h);)h++;if(h>l-r){const T=t[s];for(;r<l;)e.insertBefore(a[r++],T)}else e.replaceChild(a[r++],t[s++])}else s++;else t[s++].remove()}}}const V="_$DX_DELEGATE";function we(e,t,a){let o;return le(i=>{o=i,t===document?e():D(t,e(),t.firstChild?null:void 0,a)}),()=>{o(),t.textContent=""}}function O(e,t,a){const o=document.createElement("template");o.innerHTML=e;let i=o.content.firstChild;return a&&(i=i.firstChild),i}function Te(e,t=window.document){const a=t[V]||(t[V]=new Set);for(let o=0,i=e.length;o<i;o++){const n=e[o];a.has(n)||(a.add(n),t.addEventListener(n,Se))}}function M(e,t,a){a==null?e.removeAttribute(t):e.setAttribute(t,a)}function ke(e,t){t==null?e.removeAttribute("class"):e.className=t}function ve(e,t,a){return N(()=>e(t,a))}function D(e,t,a,o){if(a!==void 0&&!o&&(o=[]),typeof t!="function")return W(e,t,o,a);H(i=>W(e,t(),i,a),o)}function Se(e){const t=`$$${e.type}`;let a=e.composedPath&&e.composedPath()[0]||e.target;for(e.target!==a&&Object.defineProperty(e,"target",{configurable:!0,value:a}),Object.defineProperty(e,"currentTarget",{configurable:!0,get(){return a||document}}),S.registry&&!S.done&&(S.done=!0,document.querySelectorAll("[id^=pl-]").forEach(o=>o.remove()));a!==null;){const o=a[t];if(o&&!a.disabled){const i=a[`${t}Data`];if(i!==void 0?o.call(a,i,e):o.call(a,e),e.cancelBubble)return}a=a.host&&a.host!==a&&a.host instanceof Node?a.host:a.parentNode}}function W(e,t,a,o,i){for(S.context&&!a&&(a=[...e.childNodes]);typeof a=="function";)a=a();if(t===a)return a;const n=typeof t,s=o!==void 0;if(e=s&&a[0]&&a[0].parentNode||e,n==="string"||n==="number"){if(S.context)return a;if(n==="number"&&(t=t.toString()),s){let r=a[0];r&&r.nodeType===3?r.data=t:r=document.createTextNode(t),a=C(e,a,o,r)}else a!==""&&typeof a=="string"?a=e.firstChild.data=t:a=e.textContent=t}else if(t==null||n==="boolean"){if(S.context)return a;a=C(e,a,o)}else{if(n==="function")return H(()=>{let r=t();for(;typeof r=="function";)r=r();a=W(e,r,a,o)}),()=>a;if(Array.isArray(t)){const r=[],y=a&&Array.isArray(a);if(z(r,t,a,i))return H(()=>a=W(e,r,a,o,!0)),()=>a;if(S.context){if(!r.length)return a;for(let u=0;u<r.length;u++)if(r[u].parentNode)return a=r}if(r.length===0){if(a=C(e,a,o),s)return a}else y?a.length===0?_(e,r,o):be(e,a,r):(a&&C(e),_(e,r));a=r}else if(t instanceof Node){if(S.context&&t.parentNode)return a=s?[t]:t;if(Array.isArray(a)){if(s)return a=C(e,a,o,t);C(e,a,null,t)}else a==null||a===""||!e.firstChild?e.appendChild(t):e.replaceChild(t,e.firstChild);a=t}}return a}function z(e,t,a,o){let i=!1;for(let n=0,s=t.length;n<s;n++){let r=t[n],y=a&&a[n];if(r instanceof Node)e.push(r);else if(!(r==null||r===!0||r===!1))if(Array.isArray(r))i=z(e,r,y)||i;else if(typeof r=="function")if(o){for(;typeof r=="function";)r=r();i=z(e,Array.isArray(r)?r:[r],y)||i}else e.push(r),i=!0;else{const u=String(r);y&&y.nodeType===3&&y.data===u?e.push(y):e.push(document.createTextNode(u))}}return i}function _(e,t,a){for(let o=0,i=t.length;o<i;o++)e.insertBefore(t[o],a)}function C(e,t,a,o){if(a===void 0)return e.textContent="";const i=o||document.createTextNode("");if(t.length){let n=!1;for(let s=t.length-1;s>=0;s--){const r=t[s];if(i!==r){const y=r.parentNode===e;!n&&!s?y?e.replaceChild(i,r):e.insertBefore(i,a):y&&r.remove()}else n=!0}}else e.insertBefore(i,a);return[i]}const ne=[{id:1,name:"Wireless Vaccine+-",faction:"FAKE TECH",rarity:4,frameSize:"C",type:"Item",subtype:"Weapon",bodyText:`"Not feeling well? Well, maybe it's 'cause you're always on that phone."
...
Long Warp: Play one round of Rock-Paper-Scissors with your opponent. If you win, receive 1x Teleportation Token, giving you a free instant dodge from an attack of your choice. If you lose, discard the top card of your deck.`,variantId:131,fileStem:"0094a"}],Ae=e=>`https://mondomegabits.com/card/img/95/${e.fileStem}.jpg`,$=e=>{const t=ne.find(a=>a.id.toString()===e.toString());return Ae(t)},Ee=e=>[...ne].sort(()=>.5-Math.random()).slice(0,e),K="minted-card-animation",R=()=>{document.querySelectorAll(`.${K}`).forEach(e=>e.remove())},Ie=(e,t)=>{const a=t?.g||-3,o=t?.dt||20,i=t?.bounce||.99,n=t?.endVelocity||0,s=t?.stagger||200,r=t?.clear||!1,y=t?.callback||null,u=window.innerHeight,l=(h,f,T,p,c)=>{const d=h.cloneNode(!0);document.body.append(d);const v=Math.min(u-f,T.top+c),k={left:T.left+p,top:v};d.style.top=`${k.top}px`,d.style.left=`${k.left}px`,Math.abs(v-(u-f))<5?k.left>window.innerWidth||k.left<0?y?.(h):c<0||c>n?(c*=-1*i,setTimeout(()=>{l(d,f,k,p,c)},o)):y?.(h):(c=c-a,setTimeout(()=>{l(d,f,k,p,c)},o))},w=(h,f,T)=>{let p=Math.floor(Math.random()*10)+5;Math.random()<.5&&(p=-p);const d=h.cloneNode(!0);d.classList.add(K),d.style.position="fixed",d.style.top=`${h.offsetTop}px`,d.style.left=`${h.offsetLeft}px`,d.style.zIndex=1,document.body.append(d),setTimeout(()=>{const v={top:d.offsetTop,left:d.offsetLeft};l(d,f,v,p,0)},T)};r&&R(),e.forEach((h,f)=>{h.offsetHeight<window.outerHeight&&!h.classList.contains(`.${K}`)&&w(h,h.offsetHeight,f*s)})};const Ce=O('<div class="minted-cards"><div><div class="card-select-cards"></div></div></div>'),Me=O('<img alt="">'),Re=O('<div class="minted-card-display"></div>'),De=O('<div class="minted-card-display-card"><img alt=""></div>'),He=({cards:e=[],callback:t=()=>{},cardSize:a={width:168,height:284},timeBetweenFrames:o=20})=>{let i;const[n,s]=he([]);de(()=>{R()}),ue(()=>{R()}),Z(()=>{if(e.length===0)return;(()=>{const w=f=>{const T=f.getAttribute("data-card");s([...new Set([...n(),T])])},h=i.querySelectorAll("[data-card]");Ie(h,{callback:w,dt:o})})()});const r=()=>{R(),s([]),t?.()},y=()=>{R(),i.querySelectorAll(".minted-card-display-card img").forEach(f=>{f.classList.add("spin-out")}),i.querySelector(".minted-card-display").classList.add("fade-out"),setTimeout(()=>{r()},500)},u=()=>n().length>0&&n().length===e.length;return(()=>{const l=Ce.cloneNode(!0),w=l.firstChild,h=w.firstChild,f=i;return typeof f=="function"?ve(f,l):i=l,D(h,()=>e.map(T=>(()=>{const p=Me.cloneNode(!0);return H(c=>{const d=$(T.id),v=a.width,k=a.height,q=T.id;return d!==c._v$&&M(p,"src",c._v$=d),v!==c._v$2&&M(p,"width",c._v$2=v),k!==c._v$3&&M(p,"height",c._v$3=k),q!==c._v$4&&M(p,"data-card",c._v$4=q),c},{_v$:void 0,_v$2:void 0,_v$3:void 0,_v$4:void 0}),p})())),D(l,(()=>{const T=ge(()=>!!u(),!0);return()=>T()&&(()=>{const p=Re.cloneNode(!0);return p.$$click=y,D(p,()=>n().map(c=>{const d=$(c);return(()=>{const v=De.cloneNode(!0),k=v.firstChild;return M(k,"src",d),v})()})),p})()})(),null),H(()=>ke(w,`card-select${u()?" spotlight-open":""}`)),l})()};Te(["click"]);const Ne=O('<div class="app"></div>'),Ge=Ee(5),Pe=()=>(()=>{const e=Ne.cloneNode(!0);return D(e,ie(He,{cards:Ge,cardSize:{width:168,height:284},timeBetweenFrames:20,callback:()=>{console.log("Finished!")}})),e})();we(()=>ie(Pe,{}),document.getElementById("root"));
