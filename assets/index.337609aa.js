(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))o(i);new MutationObserver(i=>{for(const n of i)if(n.type==="childList")for(const s of n.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&o(s)}).observe(document,{childList:!0,subtree:!0});function a(i){const n={};return i.integrity&&(n.integrity=i.integrity),i.referrerpolicy&&(n.referrerPolicy=i.referrerpolicy),i.crossorigin==="use-credentials"?n.credentials="include":i.crossorigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function o(i){if(i.ep)return;i.ep=!0;const n=a(i);fetch(i.href,n)}})();const b={};function ie(e){b.context=e}const ne=(e,t)=>e===t,N={equals:ne};let X=te;const k=1,G=2,Z={owned:null,cleanups:null,context:null,owner:null};var y=null;let A=null,u=null,f=null,w=null,Y=0;function re(e,t){const a=u,o=y,i=e.length===0,n=i?Z:{owned:null,cleanups:null,context:null,owner:t||o},s=i?e:()=>e(()=>x(()=>j(n)));y=n,u=null;try{return M(s,!0)}finally{u=a,y=o}}function se(e,t){t=t?Object.assign({},N,t):N;const a={value:e,observers:null,observerSlots:null,comparator:t.equals||void 0},o=i=>(typeof i=="function"&&(i=i(a.value)),ee(a,i));return[Q.bind(a),o]}function P(e,t,a){const o=U(e,t,!1,k);C(o)}function le(e,t,a){X=ye;const o=U(e,t,!1,k);o.user=!0,w?w.push(o):C(o)}function he(e,t,a){a=a?Object.assign({},N,a):N;const o=U(e,t,!0,0);return o.observers=null,o.observerSlots=null,o.comparator=a.equals||void 0,C(o),Q.bind(o)}function x(e){let t,a=u;return u=null,t=e(),u=a,t}function ce(e){le(()=>x(e))}function ue(e){return y===null||(y.cleanups===null?y.cleanups=[e]:y.cleanups.push(e)),e}function Q(){const e=A;if(this.sources&&(this.state||e))if(this.state===k||e)C(this);else{const t=f;f=null,M(()=>F(this),!1),f=t}if(u){const t=this.observers?this.observers.length:0;u.sources?(u.sources.push(this),u.sourceSlots.push(t)):(u.sources=[this],u.sourceSlots=[t]),this.observers?(this.observers.push(u),this.observerSlots.push(u.sources.length-1)):(this.observers=[u],this.observerSlots=[u.sources.length-1])}return this.value}function ee(e,t,a){let o=e.value;return(!e.comparator||!e.comparator(o,t))&&(e.value=t,e.observers&&e.observers.length&&M(()=>{for(let i=0;i<e.observers.length;i+=1){const n=e.observers[i],s=A&&A.running;s&&A.disposed.has(n),(s&&!n.tState||!s&&!n.state)&&(n.pure?f.push(n):w.push(n),n.observers&&ae(n)),s||(n.state=k)}if(f.length>1e6)throw f=[],new Error},!1)),t}function C(e){if(!e.fn)return;j(e);const t=y,a=u,o=Y;u=y=e,de(e,e.value,o),u=a,y=t}function de(e,t,a){let o;try{o=e.fn(t)}catch(i){e.pure&&(e.state=k),oe(i)}(!e.updatedAt||e.updatedAt<=a)&&(e.updatedAt!=null&&"observers"in e?ee(e,o):e.value=o,e.updatedAt=a)}function U(e,t,a,o=k,i){const n={fn:e,state:o,updatedAt:null,owned:null,sources:null,sourceSlots:null,cleanups:null,value:t,owner:y,context:null,pure:a};return y===null||y!==Z&&(y.owned?y.owned.push(n):y.owned=[n]),n}function O(e){const t=A;if(e.state===0||t)return;if(e.state===G||t)return F(e);if(e.suspense&&x(e.suspense.inFallback))return e.suspense.effects.push(e);const a=[e];for(;(e=e.owner)&&(!e.updatedAt||e.updatedAt<Y);)(e.state||t)&&a.push(e);for(let o=a.length-1;o>=0;o--)if(e=a[o],e.state===k||t)C(e);else if(e.state===G||t){const i=f;f=null,M(()=>F(e,a[0]),!1),f=i}}function M(e,t){if(f)return e();let a=!1;t||(f=[]),w?a=!0:w=[],Y++;try{const o=e();return me(a),o}catch(o){f||(w=null),oe(o)}}function me(e){if(f&&(te(f),f=null),e)return;const t=w;w=null,t.length&&M(()=>X(t),!1)}function te(e){for(let t=0;t<e.length;t++)O(e[t])}function ye(e){let t,a=0;for(t=0;t<e.length;t++){const o=e[t];o.user?e[a++]=o:O(o)}for(b.context&&ie(),t=0;t<a;t++)O(e[t])}function F(e,t){const a=A;e.state=0;for(let o=0;o<e.sources.length;o+=1){const i=e.sources[o];i.sources&&(i.state===k||a?i!==t&&O(i):(i.state===G||a)&&F(i,t))}}function ae(e){const t=A;for(let a=0;a<e.observers.length;a+=1){const o=e.observers[a];(!o.state||t)&&(o.state=G,o.pure?f.push(o):w.push(o),o.observers&&ae(o))}}function j(e){let t;if(e.sources)for(;e.sources.length;){const a=e.sources.pop(),o=e.sourceSlots.pop(),i=a.observers;if(i&&i.length){const n=i.pop(),s=a.observerSlots.pop();o<i.length&&(n.sourceSlots[s]=o,i[o]=n,a.observerSlots[o]=s)}}if(e.owned){for(t=0;t<e.owned.length;t++)j(e.owned[t]);e.owned=null}if(e.cleanups){for(t=0;t<e.cleanups.length;t++)e.cleanups[t]();e.cleanups=null}e.state=0,e.context=null}function fe(e){return e instanceof Error||typeof e=="string"?e:new Error("Unknown error")}function oe(e){throw e=fe(e),e}function pe(e,t){return x(()=>e(t||{}))}function ge(e,t){return he(e,void 0,t?void 0:{equals:t})}function be(e,t,a){let o=a.length,i=t.length,n=o,s=0,r=0,h=t[i-1].nextSibling,l=null;for(;s<i||r<n;){if(t[s]===a[r]){s++,r++;continue}for(;t[i-1]===a[n-1];)i--,n--;if(i===s){const c=n<o?r?a[r-1].nextSibling:a[n-r]:h;for(;r<n;)e.insertBefore(a[r++],c)}else if(n===r)for(;s<i;)(!l||!l.has(t[s]))&&t[s].remove(),s++;else if(t[s]===a[n-1]&&a[r]===t[i-1]){const c=t[--i].nextSibling;e.insertBefore(a[r++],t[s++].nextSibling),e.insertBefore(a[--n],c),t[i]=a[n]}else{if(!l){l=new Map;let m=r;for(;m<n;)l.set(a[m],m++)}const c=l.get(t[s]);if(c!=null)if(r<c&&c<n){let m=s,g=1,p;for(;++m<i&&m<n&&!((p=l.get(t[m]))==null||p!==c+g);)g++;if(g>c-r){const T=t[s];for(;r<c;)e.insertBefore(a[r++],T)}else e.replaceChild(a[r++],t[s++])}else s++;else t[s++].remove()}}}const V="_$DX_DELEGATE";function we(e,t,a){let o;return re(i=>{o=i,t===document?e():D(t,e(),t.firstChild?null:void 0,a)}),()=>{o(),t.textContent=""}}function L(e,t,a){const o=document.createElement("template");o.innerHTML=e;let i=o.content.firstChild;return a&&(i=i.firstChild),i}function Te(e,t=window.document){const a=t[V]||(t[V]=new Set);for(let o=0,i=e.length;o<i;o++){const n=e[o];a.has(n)||(a.add(n),t.addEventListener(n,ke))}}function W(e,t,a){a==null?e.removeAttribute(t):e.setAttribute(t,a)}function D(e,t,a,o){if(a!==void 0&&!o&&(o=[]),typeof t!="function")return B(e,t,o,a);P(i=>B(e,t(),i,a),o)}function ke(e){const t=`$$${e.type}`;let a=e.composedPath&&e.composedPath()[0]||e.target;for(e.target!==a&&Object.defineProperty(e,"target",{configurable:!0,value:a}),Object.defineProperty(e,"currentTarget",{configurable:!0,get(){return a||document}}),b.registry&&!b.done&&(b.done=!0,document.querySelectorAll("[id^=pl-]").forEach(o=>o.remove()));a!==null;){const o=a[t];if(o&&!a.disabled){const i=a[`${t}Data`];if(i!==void 0?o.call(a,i,e):o.call(a,e),e.cancelBubble)return}a=a.host&&a.host!==a&&a.host instanceof Node?a.host:a.parentNode}}function B(e,t,a,o,i){for(b.context&&!a&&(a=[...e.childNodes]);typeof a=="function";)a=a();if(t===a)return a;const n=typeof t,s=o!==void 0;if(e=s&&a[0]&&a[0].parentNode||e,n==="string"||n==="number"){if(b.context)return a;if(n==="number"&&(t=t.toString()),s){let r=a[0];r&&r.nodeType===3?r.data=t:r=document.createTextNode(t),a=I(e,a,o,r)}else a!==""&&typeof a=="string"?a=e.firstChild.data=t:a=e.textContent=t}else if(t==null||n==="boolean"){if(b.context)return a;a=I(e,a,o)}else{if(n==="function")return P(()=>{let r=t();for(;typeof r=="function";)r=r();a=B(e,r,a,o)}),()=>a;if(Array.isArray(t)){const r=[],h=a&&Array.isArray(a);if(z(r,t,a,i))return P(()=>a=B(e,r,a,o,!0)),()=>a;if(b.context){if(!r.length)return a;for(let l=0;l<r.length;l++)if(r[l].parentNode)return a=r}if(r.length===0){if(a=I(e,a,o),s)return a}else h?a.length===0?_(e,r,o):be(e,a,r):(a&&I(e),_(e,r));a=r}else if(t instanceof Node){if(b.context&&t.parentNode)return a=s?[t]:t;if(Array.isArray(a)){if(s)return a=I(e,a,o,t);I(e,a,null,t)}else a==null||a===""||!e.firstChild?e.appendChild(t):e.replaceChild(t,e.firstChild);a=t}}return a}function z(e,t,a,o){let i=!1;for(let n=0,s=t.length;n<s;n++){let r=t[n],h=a&&a[n];if(r instanceof Node)e.push(r);else if(!(r==null||r===!0||r===!1))if(Array.isArray(r))i=z(e,r,h)||i;else if(typeof r=="function")if(o){for(;typeof r=="function";)r=r();i=z(e,Array.isArray(r)?r:[r],h)||i}else e.push(r),i=!0;else{const l=String(r);h&&h.nodeType===3&&h.data===l?e.push(h):e.push(document.createTextNode(l))}}return i}function _(e,t,a){for(let o=0,i=t.length;o<i;o++)e.insertBefore(t[o],a)}function I(e,t,a,o){if(a===void 0)return e.textContent="";const i=o||document.createTextNode("");if(t.length){let n=!1;for(let s=t.length-1;s>=0;s--){const r=t[s];if(i!==r){const h=r.parentNode===e;!n&&!s?h?e.replaceChild(i,r):e.insertBefore(i,a):h&&r.remove()}else n=!0}}else e.insertBefore(i,a);return[i]}const K="minted-card-animation",ve=(e,t)=>{const a=t?.g||-3,o=t?.dt||5,i=t?.bounce||.99,n=t?.endVelocity||0,s=t?.stagger||200,r=t?.fallToLeft||!1,h=t?.clear||!1,l=t?.callback||null,c=window.innerHeight,m=(p,T,R,v,d)=>{const S=p.cloneNode(!0);document.body.append(S);const q=Math.min(c-T,R.top+d),E={left:R.left+v,top:q};S.style.top=`${E.top}px`,S.style.left=`${E.left}px`,Math.abs(q-(c-T))<5?E.left>window.innerWidth||E.left<0?l?.(p):d<0||d>n?(d*=-1*i,setTimeout(()=>{m(S,T,E,v,d)},o)):l?.(p):(d=d-a,setTimeout(()=>{m(S,T,E,v,d)},o))},g=(p,T,R)=>{let v=Math.floor(Math.random()*10)+5;r&&(v=-v);const d=p.cloneNode(!0);d.classList.add(K),d.style.position="fixed",d.style.top=`${p.offsetTop}px`,d.style.left=`${p.offsetLeft}px`,d.style.zIndex=1,document.body.append(d),setTimeout(()=>{const S={top:d.offsetTop,left:d.offsetLeft};m(d,T,S,v,0)},R)};h&&H(),e.forEach(p=>{p.offsetHeight<window.outerHeight&&!p.classList.contains(`.${K}`)&&g(p,p.offsetHeight,1*s)})},H=()=>{document.querySelectorAll(`.${K}`).forEach(e=>e.remove())},$=[{id:1,name:"Wireless Vaccine+-",faction:"FAKE TECH",rarity:4,frameSize:"C",type:"Item",subtype:"Weapon",bodyText:`"Not feeling well? Well, maybe it's 'cause you're always on that phone."
...
Long Warp: Play one round of Rock-Paper-Scissors with your opponent. If you win, receive 1x Teleportation Token, giving you a free instant dodge from an attack of your choice. If you lose, discard the top card of your deck.`,variantId:131,fileStem:"0094a"}],J=e=>`https://mondomegabits.com/card/img/95/${e.fileStem}.jpg`,Se=e=>{const t=[];for(var a=0;a<e;a++)t.push($[Math.floor(Math.random()*$.length)]);return t},Ae=L('<div class="app"><div class="card-select"><h4>Click on a card to <span class="color-change">MINT</span> it</h4><div class="card-select-cards"></div></div></div>'),Ee=L('<img width="168" height="284" alt="">'),Ie=L('<div class="minted-card-display"></div>'),Ce=L('<img alt="">'),Me=()=>{const[e,t]=se([]);ce(()=>{H()}),ue(()=>{H()});const a=i=>{const n=i.target,s=h=>{const l=JSON.parse(h.getAttribute("data-card"));t([...new Set([...e(),l])])},r=Math.random()<.5;ve([n],{callback:s,fallToLeft:r})},o=()=>{t([]),H()};return(()=>{const i=Ae.cloneNode(!0),n=i.firstChild,s=n.firstChild,r=s.nextSibling;return D(r,()=>Se(5).map(h=>(()=>{const l=Ee.cloneNode(!0);return l.$$click=a,P(c=>{const m=J(h),g=JSON.stringify(h);return m!==c._v$&&W(l,"src",c._v$=m),g!==c._v$2&&W(l,"data-card",c._v$2=g),c},{_v$:void 0,_v$2:void 0}),l})())),D(i,(()=>{const h=ge(()=>!!e().length,!0);return()=>h()&&(()=>{const l=Ie.cloneNode(!0);return l.$$click=o,D(l,()=>e().map(c=>{const m=J(c);return(()=>{const g=Ce.cloneNode(!0);return W(g,"src",m),g})()})),l})()})(),null),i})()};Te(["click"]);we(()=>pe(Me,{}),document.getElementById("root"));
