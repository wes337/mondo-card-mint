(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))o(i);new MutationObserver(i=>{for(const n of i)if(n.type==="childList")for(const s of n.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&o(s)}).observe(document,{childList:!0,subtree:!0});function a(i){const n={};return i.integrity&&(n.integrity=i.integrity),i.referrerpolicy&&(n.referrerPolicy=i.referrerpolicy),i.crossorigin==="use-credentials"?n.credentials="include":i.crossorigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function o(i){if(i.ep)return;i.ep=!0;const n=a(i);fetch(i.href,n)}})();const S={};function re(e){S.context=e}const se=(e,t)=>e===t,P={equals:se};let X=te;const E=1,O=2,Z={owned:null,cleanups:null,context:null,owner:null};var p=null;let I=null,m=null,g=null,v=null,U=0;function le(e,t){const a=m,o=p,i=e.length===0,n=i?Z:{owned:null,cleanups:null,context:null,owner:t||o},s=i?e:()=>e(()=>L(()=>q(n)));p=n,m=null;try{return H(s,!0)}finally{m=a,p=o}}function V(e,t){t=t?Object.assign({},P,t):P;const a={value:e,observers:null,observerSlots:null,comparator:t.equals||void 0},o=i=>(typeof i=="function"&&(i=i(a.value)),ee(a,i));return[Q.bind(a),o]}function R(e,t,a){const o=j(e,t,!1,E);D(o)}function he(e,t,a){X=fe;const o=j(e,t,!1,E);o.user=!0,v?v.push(o):D(o)}function ce(e,t,a){a=a?Object.assign({},P,a):P;const o=j(e,t,!0,0);return o.observers=null,o.observerSlots=null,o.comparator=a.equals||void 0,D(o),Q.bind(o)}function L(e){let t,a=m;return m=null,t=e(),m=a,t}function ue(e){he(()=>L(e))}function de(e){return p===null||(p.cleanups===null?p.cleanups=[e]:p.cleanups.push(e)),e}function Q(){const e=I;if(this.sources&&(this.state||e))if(this.state===E||e)D(this);else{const t=g;g=null,H(()=>F(this),!1),g=t}if(m){const t=this.observers?this.observers.length:0;m.sources?(m.sources.push(this),m.sourceSlots.push(t)):(m.sources=[this],m.sourceSlots=[t]),this.observers?(this.observers.push(m),this.observerSlots.push(m.sources.length-1)):(this.observers=[m],this.observerSlots=[m.sources.length-1])}return this.value}function ee(e,t,a){let o=e.value;return(!e.comparator||!e.comparator(o,t))&&(e.value=t,e.observers&&e.observers.length&&H(()=>{for(let i=0;i<e.observers.length;i+=1){const n=e.observers[i],s=I&&I.running;s&&I.disposed.has(n),(s&&!n.tState||!s&&!n.state)&&(n.pure?g.push(n):v.push(n),n.observers&&ae(n)),s||(n.state=E)}if(g.length>1e6)throw g=[],new Error},!1)),t}function D(e){if(!e.fn)return;q(e);const t=p,a=m,o=U;m=p=e,me(e,e.value,o),m=a,p=t}function me(e,t,a){let o;try{o=e.fn(t)}catch(i){e.pure&&(e.state=E),oe(i)}(!e.updatedAt||e.updatedAt<=a)&&(e.updatedAt!=null&&"observers"in e?ee(e,o):e.value=o,e.updatedAt=a)}function j(e,t,a,o=E,i){const n={fn:e,state:o,updatedAt:null,owned:null,sources:null,sourceSlots:null,cleanups:null,value:t,owner:p,context:null,pure:a};return p===null||p!==Z&&(p.owned?p.owned.push(n):p.owned=[n]),n}function B(e){const t=I;if(e.state===0||t)return;if(e.state===O||t)return F(e);if(e.suspense&&L(e.suspense.inFallback))return e.suspense.effects.push(e);const a=[e];for(;(e=e.owner)&&(!e.updatedAt||e.updatedAt<U);)(e.state||t)&&a.push(e);for(let o=a.length-1;o>=0;o--)if(e=a[o],e.state===E||t)D(e);else if(e.state===O||t){const i=g;g=null,H(()=>F(e,a[0]),!1),g=i}}function H(e,t){if(g)return e();let a=!1;t||(g=[]),v?a=!0:v=[],U++;try{const o=e();return ye(a),o}catch(o){g||(v=null),oe(o)}}function ye(e){if(g&&(te(g),g=null),e)return;const t=v;v=null,t.length&&H(()=>X(t),!1)}function te(e){for(let t=0;t<e.length;t++)B(e[t])}function fe(e){let t,a=0;for(t=0;t<e.length;t++){const o=e[t];o.user?e[a++]=o:B(o)}for(S.context&&re(),t=0;t<a;t++)B(e[t])}function F(e,t){const a=I;e.state=0;for(let o=0;o<e.sources.length;o+=1){const i=e.sources[o];i.sources&&(i.state===E||a?i!==t&&B(i):(i.state===O||a)&&F(i,t))}}function ae(e){const t=I;for(let a=0;a<e.observers.length;a+=1){const o=e.observers[a];(!o.state||t)&&(o.state=O,o.pure?g.push(o):v.push(o),o.observers&&ae(o))}}function q(e){let t;if(e.sources)for(;e.sources.length;){const a=e.sources.pop(),o=e.sourceSlots.pop(),i=a.observers;if(i&&i.length){const n=i.pop(),s=a.observerSlots.pop();o<i.length&&(n.sourceSlots[s]=o,i[o]=n,a.observerSlots[o]=s)}}if(e.owned){for(t=0;t<e.owned.length;t++)q(e.owned[t]);e.owned=null}if(e.cleanups){for(t=0;t<e.cleanups.length;t++)e.cleanups[t]();e.cleanups=null}e.state=0,e.context=null}function pe(e){return e instanceof Error||typeof e=="string"?e:new Error("Unknown error")}function oe(e){throw e=pe(e),e}function ge(e,t){return L(()=>e(t||{}))}function be(e,t){return ce(e,void 0,t?void 0:{equals:t})}function we(e,t,a){let o=a.length,i=t.length,n=o,s=0,r=0,y=t[i-1].nextSibling,u=null;for(;s<i||r<n;){if(t[s]===a[r]){s++,r++;continue}for(;t[i-1]===a[n-1];)i--,n--;if(i===s){const l=n<o?r?a[r-1].nextSibling:a[n-r]:y;for(;r<n;)e.insertBefore(a[r++],l)}else if(n===r)for(;s<i;)(!u||!u.has(t[s]))&&t[s].remove(),s++;else if(t[s]===a[n-1]&&a[r]===t[i-1]){const l=t[--i].nextSibling;e.insertBefore(a[r++],t[s++].nextSibling),e.insertBefore(a[--n],l),t[i]=a[n]}else{if(!u){u=new Map;let d=r;for(;d<n;)u.set(a[d],d++)}const l=u.get(t[s]);if(l!=null)if(r<l&&l<n){let d=s,h=1,f;for(;++d<i&&d<n&&!((f=u.get(t[d]))==null||f!==l+h);)h++;if(h>l-r){const A=t[s];for(;r<l;)e.insertBefore(a[r++],A)}else e.replaceChild(a[r++],t[s++])}else s++;else t[s++].remove()}}}const $="_$DX_DELEGATE";function Te(e,t,a){let o;return le(i=>{o=i,t===document?e():G(t,e(),t.firstChild?null:void 0,a)}),()=>{o(),t.textContent=""}}function W(e,t,a){const o=document.createElement("template");o.innerHTML=e;let i=o.content.firstChild;return a&&(i=i.firstChild),i}function ke(e,t=window.document){const a=t[$]||(t[$]=new Set);for(let o=0,i=e.length;o<i;o++){const n=e[o];a.has(n)||(a.add(n),t.addEventListener(n,Se))}}function z(e,t,a){a==null?e.removeAttribute(t):e.setAttribute(t,a)}function _(e,t){t==null?e.removeAttribute("class"):e.className=t}function G(e,t,a,o){if(a!==void 0&&!o&&(o=[]),typeof t!="function")return x(e,t,o,a);R(i=>x(e,t(),i,a),o)}function Se(e){const t=`$$${e.type}`;let a=e.composedPath&&e.composedPath()[0]||e.target;for(e.target!==a&&Object.defineProperty(e,"target",{configurable:!0,value:a}),Object.defineProperty(e,"currentTarget",{configurable:!0,get(){return a||document}}),S.registry&&!S.done&&(S.done=!0,document.querySelectorAll("[id^=pl-]").forEach(o=>o.remove()));a!==null;){const o=a[t];if(o&&!a.disabled){const i=a[`${t}Data`];if(i!==void 0?o.call(a,i,e):o.call(a,e),e.cancelBubble)return}a=a.host&&a.host!==a&&a.host instanceof Node?a.host:a.parentNode}}function x(e,t,a,o,i){for(S.context&&!a&&(a=[...e.childNodes]);typeof a=="function";)a=a();if(t===a)return a;const n=typeof t,s=o!==void 0;if(e=s&&a[0]&&a[0].parentNode||e,n==="string"||n==="number"){if(S.context)return a;if(n==="number"&&(t=t.toString()),s){let r=a[0];r&&r.nodeType===3?r.data=t:r=document.createTextNode(t),a=C(e,a,o,r)}else a!==""&&typeof a=="string"?a=e.firstChild.data=t:a=e.textContent=t}else if(t==null||n==="boolean"){if(S.context)return a;a=C(e,a,o)}else{if(n==="function")return R(()=>{let r=t();for(;typeof r=="function";)r=r();a=x(e,r,a,o)}),()=>a;if(Array.isArray(t)){const r=[],y=a&&Array.isArray(a);if(K(r,t,a,i))return R(()=>a=x(e,r,a,o,!0)),()=>a;if(S.context){if(!r.length)return a;for(let u=0;u<r.length;u++)if(r[u].parentNode)return a=r}if(r.length===0){if(a=C(e,a,o),s)return a}else y?a.length===0?J(e,r,o):we(e,a,r):(a&&C(e),J(e,r));a=r}else if(t instanceof Node){if(S.context&&t.parentNode)return a=s?[t]:t;if(Array.isArray(a)){if(s)return a=C(e,a,o,t);C(e,a,null,t)}else a==null||a===""||!e.firstChild?e.appendChild(t):e.replaceChild(t,e.firstChild);a=t}}return a}function K(e,t,a,o){let i=!1;for(let n=0,s=t.length;n<s;n++){let r=t[n],y=a&&a[n];if(r instanceof Node)e.push(r);else if(!(r==null||r===!0||r===!1))if(Array.isArray(r))i=K(e,r,y)||i;else if(typeof r=="function")if(o){for(;typeof r=="function";)r=r();i=K(e,Array.isArray(r)?r:[r],y)||i}else e.push(r),i=!0;else{const u=String(r);y&&y.nodeType===3&&y.data===u?e.push(y):e.push(document.createTextNode(u))}}return i}function J(e,t,a){for(let o=0,i=t.length;o<i;o++)e.insertBefore(t[o],a)}function C(e,t,a,o){if(a===void 0)return e.textContent="";const i=o||document.createTextNode("");if(t.length){let n=!1;for(let s=t.length-1;s>=0;s--){const r=t[s];if(i!==r){const y=r.parentNode===e;!n&&!s?y?e.replaceChild(i,r):e.insertBefore(i,a):y&&r.remove()}else n=!0}}else e.insertBefore(i,a);return[i]}const Y="minted-card-animation",M=()=>{document.querySelectorAll(`.${Y}`).forEach(e=>e.remove())},ve=(e,t)=>{const a=t?.g||-3,o=t?.dt||5,i=t?.bounce||.99,n=t?.endVelocity||0,s=t?.stagger||200,r=t?.clear||!1,y=t?.callback||null,u=window.innerHeight,l=(h,f,A,w,b)=>{const c=h.cloneNode(!0);document.body.append(c);const T=Math.min(u-f,A.top+b),k={left:A.left+w,top:T};c.style.top=`${k.top}px`,c.style.left=`${k.left}px`,Math.abs(T-(u-f))<5?k.left>window.innerWidth||k.left<0?y?.(h):b<0||b>n?(b*=-1*i,setTimeout(()=>{l(c,f,k,w,b)},o)):y?.(h):(b=b-a,setTimeout(()=>{l(c,f,k,w,b)},o))},d=(h,f,A)=>{let w=Math.floor(Math.random()*10)+5;Math.random()<.5&&(w=-w);const c=h.cloneNode(!0);c.classList.add(Y),c.style.position="fixed",c.style.top=`${h.offsetTop}px`,c.style.left=`${h.offsetLeft}px`,c.style.zIndex=1,document.body.append(c),setTimeout(()=>{const T={top:c.offsetTop,left:c.offsetLeft};l(c,f,T,w,0)},A)};r&&M(),e.forEach((h,f)=>{h.offsetHeight<window.outerHeight&&!h.classList.contains(`.${Y}`)&&d(h,h.offsetHeight,f*s)})},ie=[{id:1,name:"Wireless Vaccine+-",faction:"FAKE TECH",rarity:4,frameSize:"C",type:"Item",subtype:"Weapon",bodyText:`"Not feeling well? Well, maybe it's 'cause you're always on that phone."
