(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))o(i);new MutationObserver(i=>{for(const n of i)if(n.type==="childList")for(const s of n.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&o(s)}).observe(document,{childList:!0,subtree:!0});function a(i){const n={};return i.integrity&&(n.integrity=i.integrity),i.referrerpolicy&&(n.referrerPolicy=i.referrerpolicy),i.crossorigin==="use-credentials"?n.credentials="include":i.crossorigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function o(i){if(i.ep)return;i.ep=!0;const n=a(i);fetch(i.href,n)}})();const k={};function ie(e){k.context=e}const ne=(e,t)=>e===t,N={equals:ne};let J=ee;const A=1,G=2,X={owned:null,cleanups:null,context:null,owner:null};var p=null;let E=null,u=null,g=null,S=null,U=0;function re(e,t){const a=u,o=p,i=e.length===0,n=i?X:{owned:null,cleanups:null,context:null,owner:t||o},s=i?e:()=>e(()=>x(()=>q(n)));p=n,u=null;try{return R(s,!0)}finally{u=a,p=o}}function V(e,t){t=t?Object.assign({},N,t):N;const a={value:e,observers:null,observerSlots:null,comparator:t.equals||void 0},o=i=>(typeof i=="function"&&(i=i(a.value)),Q(a,i));return[Z.bind(a),o]}function P(e,t,a){const o=j(e,t,!1,A);M(o)}function se(e,t,a){J=me;const o=j(e,t,!1,A);o.user=!0,S?S.push(o):M(o)}function le(e,t,a){a=a?Object.assign({},N,a):N;const o=j(e,t,!0,0);return o.observers=null,o.observerSlots=null,o.comparator=a.equals||void 0,M(o),Z.bind(o)}function x(e){let t,a=u;return u=null,t=e(),u=a,t}function he(e){se(()=>x(e))}function ce(e){return p===null||(p.cleanups===null?p.cleanups=[e]:p.cleanups.push(e)),e}function Z(){const e=E;if(this.sources&&(this.state||e))if(this.state===A||e)M(this);else{const t=g;g=null,R(()=>B(this),!1),g=t}if(u){const t=this.observers?this.observers.length:0;u.sources?(u.sources.push(this),u.sourceSlots.push(t)):(u.sources=[this],u.sourceSlots=[t]),this.observers?(this.observers.push(u),this.observerSlots.push(u.sources.length-1)):(this.observers=[u],this.observerSlots=[u.sources.length-1])}return this.value}function Q(e,t,a){let o=e.value;return(!e.comparator||!e.comparator(o,t))&&(e.value=t,e.observers&&e.observers.length&&R(()=>{for(let i=0;i<e.observers.length;i+=1){const n=e.observers[i],s=E&&E.running;s&&E.disposed.has(n),(s&&!n.tState||!s&&!n.state)&&(n.pure?g.push(n):S.push(n),n.observers&&te(n)),s||(n.state=A)}if(g.length>1e6)throw g=[],new Error},!1)),t}function M(e){if(!e.fn)return;q(e);const t=p,a=u,o=U;u=p=e,ue(e,e.value,o),u=a,p=t}function ue(e,t,a){let o;try{o=e.fn(t)}catch(i){e.pure&&(e.state=A),ae(i)}(!e.updatedAt||e.updatedAt<=a)&&(e.updatedAt!=null&&"observers"in e?Q(e,o):e.value=o,e.updatedAt=a)}function j(e,t,a,o=A,i){const n={fn:e,state:o,updatedAt:null,owned:null,sources:null,sourceSlots:null,cleanups:null,value:t,owner:p,context:null,pure:a};return p===null||p!==X&&(p.owned?p.owned.push(n):p.owned=[n]),n}function O(e){const t=E;if(e.state===0||t)return;if(e.state===G||t)return B(e);if(e.suspense&&x(e.suspense.inFallback))return e.suspense.effects.push(e);const a=[e];for(;(e=e.owner)&&(!e.updatedAt||e.updatedAt<U);)(e.state||t)&&a.push(e);for(let o=a.length-1;o>=0;o--)if(e=a[o],e.state===A||t)M(e);else if(e.state===G||t){const i=g;g=null,R(()=>B(e,a[0]),!1),g=i}}function R(e,t){if(g)return e();let a=!1;t||(g=[]),S?a=!0:S=[],U++;try{const o=e();return de(a),o}catch(o){g||(S=null),ae(o)}}function de(e){if(g&&(ee(g),g=null),e)return;const t=S;S=null,t.length&&R(()=>J(t),!1)}function ee(e){for(let t=0;t<e.length;t++)O(e[t])}function me(e){let t,a=0;for(t=0;t<e.length;t++){const o=e[t];o.user?e[a++]=o:O(o)}for(k.context&&ie(),t=0;t<a;t++)O(e[t])}function B(e,t){const a=E;e.state=0;for(let o=0;o<e.sources.length;o+=1){const i=e.sources[o];i.sources&&(i.state===A||a?i!==t&&O(i):(i.state===G||a)&&B(i,t))}}function te(e){const t=E;for(let a=0;a<e.observers.length;a+=1){const o=e.observers[a];(!o.state||t)&&(o.state=G,o.pure?g.push(o):S.push(o),o.observers&&te(o))}}function q(e){let t;if(e.sources)for(;e.sources.length;){const a=e.sources.pop(),o=e.sourceSlots.pop(),i=a.observers;if(i&&i.length){const n=i.pop(),s=a.observerSlots.pop();o<i.length&&(n.sourceSlots[s]=o,i[o]=n,a.observerSlots[o]=s)}}if(e.owned){for(t=0;t<e.owned.length;t++)q(e.owned[t]);e.owned=null}if(e.cleanups){for(t=0;t<e.cleanups.length;t++)e.cleanups[t]();e.cleanups=null}e.state=0,e.context=null}function ye(e){return e instanceof Error||typeof e=="string"?e:new Error("Unknown error")}function ae(e){throw e=ye(e),e}function fe(e,t){return x(()=>e(t||{}))}function pe(e,t){return le(e,void 0,t?void 0:{equals:t})}function ge(e,t,a){let o=a.length,i=t.length,n=o,s=0,r=0,l=t[i-1].nextSibling,h=null;for(;s<i||r<n;){if(t[s]===a[r]){s++,r++;continue}for(;t[i-1]===a[n-1];)i--,n--;if(i===s){const d=n<o?r?a[r-1].nextSibling:a[n-r]:l;for(;r<n;)e.insertBefore(a[r++],d)}else if(n===r)for(;s<i;)(!h||!h.has(t[s]))&&t[s].remove(),s++;else if(t[s]===a[n-1]&&a[r]===t[i-1]){const d=t[--i].nextSibling;e.insertBefore(a[r++],t[s++].nextSibling),e.insertBefore(a[--n],d),t[i]=a[n]}else{if(!h){h=new Map;let w=r;for(;w<n;)h.set(a[w],w++)}const d=h.get(t[s]);if(d!=null)if(r<d&&d<n){let w=s,m=1,y;for(;++w<i&&w<n&&!((y=h.get(t[w]))==null||y!==d+m);)m++;if(m>d-r){const T=t[s];for(;r<d;)e.insertBefore(a[r++],T)}else e.replaceChild(a[r++],t[s++])}else s++;else t[s++].remove()}}}const $="_$DX_DELEGATE";function be(e,t,a){let o;return re(i=>{o=i,t===document?e():D(t,e(),t.firstChild?null:void 0,a)}),()=>{o(),t.textContent=""}}function L(e,t,a){const o=document.createElement("template");o.innerHTML=e;let i=o.content.firstChild;return a&&(i=i.firstChild),i}function we(e,t=window.document){const a=t[$]||(t[$]=new Set);for(let o=0,i=e.length;o<i;o++){const n=e[o];a.has(n)||(a.add(n),t.addEventListener(n,ke))}}function W(e,t,a){a==null?e.removeAttribute(t):e.setAttribute(t,a)}function Te(e,t){t==null?e.removeAttribute("class"):e.className=t}function D(e,t,a,o){if(a!==void 0&&!o&&(o=[]),typeof t!="function")return F(e,t,o,a);P(i=>F(e,t(),i,a),o)}function ke(e){const t=`$$${e.type}`;let a=e.composedPath&&e.composedPath()[0]||e.target;for(e.target!==a&&Object.defineProperty(e,"target",{configurable:!0,value:a}),Object.defineProperty(e,"currentTarget",{configurable:!0,get(){return a||document}}),k.registry&&!k.done&&(k.done=!0,document.querySelectorAll("[id^=pl-]").forEach(o=>o.remove()));a!==null;){const o=a[t];if(o&&!a.disabled){const i=a[`${t}Data`];if(i!==void 0?o.call(a,i,e):o.call(a,e),e.cancelBubble)return}a=a.host&&a.host!==a&&a.host instanceof Node?a.host:a.parentNode}}function F(e,t,a,o,i){for(k.context&&!a&&(a=[...e.childNodes]);typeof a=="function";)a=a();if(t===a)return a;const n=typeof t,s=o!==void 0;if(e=s&&a[0]&&a[0].parentNode||e,n==="string"||n==="number"){if(k.context)return a;if(n==="number"&&(t=t.toString()),s){let r=a[0];r&&r.nodeType===3?r.data=t:r=document.createTextNode(t),a=C(e,a,o,r)}else a!==""&&typeof a=="string"?a=e.firstChild.data=t:a=e.textContent=t}else if(t==null||n==="boolean"){if(k.context)return a;a=C(e,a,o)}else{if(n==="function")return P(()=>{let r=t();for(;typeof r=="function";)r=r();a=F(e,r,a,o)}),()=>a;if(Array.isArray(t)){const r=[],l=a&&Array.isArray(a);if(z(r,t,a,i))return P(()=>a=F(e,r,a,o,!0)),()=>a;if(k.context){if(!r.length)return a;for(let h=0;h<r.length;h++)if(r[h].parentNode)return a=r}if(r.length===0){if(a=C(e,a,o),s)return a}else l?a.length===0?_(e,r,o):ge(e,a,r):(a&&C(e),_(e,r));a=r}else if(t instanceof Node){if(k.context&&t.parentNode)return a=s?[t]:t;if(Array.isArray(a)){if(s)return a=C(e,a,o,t);C(e,a,null,t)}else a==null||a===""||!e.firstChild?e.appendChild(t):e.replaceChild(t,e.firstChild);a=t}}return a}function z(e,t,a,o){let i=!1;for(let n=0,s=t.length;n<s;n++){let r=t[n],l=a&&a[n];if(r instanceof Node)e.push(r);else if(!(r==null||r===!0||r===!1))if(Array.isArray(r))i=z(e,r,l)||i;else if(typeof r=="function")if(o){for(;typeof r=="function";)r=r();i=z(e,Array.isArray(r)?r:[r],l)||i}else e.push(r),i=!0;else{const h=String(r);l&&l.nodeType===3&&l.data===h?e.push(l):e.push(document.createTextNode(h))}}return i}function _(e,t,a){for(let o=0,i=t.length;o<i;o++)e.insertBefore(t[o],a)}function C(e,t,a,o){if(a===void 0)return e.textContent="";const i=o||document.createTextNode("");if(t.length){let n=!1;for(let s=t.length-1;s>=0;s--){const r=t[s];if(i!==r){const l=r.parentNode===e;!n&&!s?l?e.replaceChild(i,r):e.insertBefore(i,a):l&&r.remove()}else n=!0}}else e.insertBefore(i,a);return[i]}const K="minted-card-animation",H=()=>{document.querySelectorAll(`.${K}`).forEach(e=>e.remove())},ve=(e,t)=>{const a=t?.g||-3,o=t?.dt||5,i=t?.bounce||.99,n=t?.endVelocity||0,s=t?.stagger||200;t?.fallToLeft;const r=t?.clear||!1,l=t?.callback||null,h=window.innerHeight,d=(m,y,T,b,f)=>{const c=m.cloneNode(!0);document.body.append(c);const v=Math.min(h-y,T.top+f),I={left:T.left+b,top:v};c.style.top=`${I.top}px`,c.style.left=`${I.left}px`,Math.abs(v-(h-y))<5?I.left>window.innerWidth||I.left<0?l?.(m):f<0||f>n?(f*=-1*i,setTimeout(()=>{d(c,y,I,b,f)},o)):l?.(m):(f=f-a,setTimeout(()=>{d(c,y,I,b,f)},o))},w=(m,y,T)=>{let b=Math.floor(Math.random()*10)+5;Math.random()<.5&&(b=-b);const c=m.cloneNode(!0);c.classList.add(K),c.style.position="fixed",c.style.top=`${m.offsetTop}px`,c.style.left=`${m.offsetLeft}px`,c.style.zIndex=1,document.body.append(c),setTimeout(()=>{const v={top:c.offsetTop,left:c.offsetLeft};d(c,y,v,b,0)},T)};r&&H(),e.forEach((m,y)=>{m.offsetHeight<window.outerHeight&&!m.classList.contains(`.${K}`)&&w(m,m.offsetHeight,y*s)})},Y=[{id:1,name:"Wireless Vaccine+-",faction:"FAKE TECH",rarity:4,frameSize:"C",type:"Item",subtype:"Weapon",bodyText:`"Not feeling well? Well, maybe it's 'cause you're always on that phone."
...
Long Warp: Play one round of Rock-Paper-Scissors with your opponent. If you win, receive 1x Teleportation Token, giving you a free instant dodge from an attack of your choice. If you lose, discard the top card of your deck.`,variantId:131,fileStem:"0094a"}],oe=e=>`https://mondomegabits.com/card/img/95/${e.fileStem}.jpg`,Se=e=>{const t=Y.find(a=>a.id.toString()===e.toString());return oe(t)},Ae=e=>{const t=[];for(var a=0;a<e;a++){const o=Math.floor(Math.random()*(Y.length-1-0+1)+0);t.push(Y[o])}return t},Ee=L('<div class="app"><div class="card-select"><h4>Select cards, then press the <span class="color-change">MINT</span> button</h4><div class="card-select-cards"></div><button class="mint-button"><span class="glow">Mint</span></button></div></div>'),Ie=L('<img width="168" height="284" alt="">'),Ce=L('<div class="minted-card-display"></div>'),Me=L('<div class="minted-card-display-card"><img alt=""></div>'),Re=Ae(5),De=()=>{const[e,t]=V([]),[a,o]=V([]);he(()=>{H()}),ce(()=>{H()});const i=l=>{e().includes(l)?t(e().filter(h=>h!==l)):t([...e(),l])},n=()=>e().map(l=>document.querySelector(`[data-card="${l}"`)),s=()=>{if(e().length===0)return;const l=d=>{const w=d.getAttribute("data-card");o([...new Set([...a(),w])])},h=n();ve(h,{callback:l})},r=()=>{t([]),o([]),H()};return(()=>{const l=Ee.cloneNode(!0),h=l.firstChild,d=h.firstChild,w=d.nextSibling,m=w.nextSibling;return D(w,()=>Re.map(y=>{const T=e().includes(y.id);return(()=>{const b=Ie.cloneNode(!0);return b.$$click=()=>i(y.id),Te(b,`${T?" selected":""}`),P(f=>{const c=oe(y),v=y.id;return c!==f._v$&&W(b,"src",f._v$=c),v!==f._v$2&&W(b,"data-card",f._v$2=v),f},{_v$:void 0,_v$2:void 0}),b})()})),m.$$click=s,D(l,(()=>{const y=pe(()=>a().length>0&&a().length===e().length,!0);return()=>y()&&(()=>{const T=Ce.cloneNode(!0);return T.$$click=r,D(T,()=>a().map(b=>{const f=Se(b);return(()=>{const c=Me.cloneNode(!0),v=c.firstChild;return W(v,"src",f),c})()})),T})()})(),null),l})()};we(["click"]);be(()=>fe(De,{}),document.getElementById("root"));
